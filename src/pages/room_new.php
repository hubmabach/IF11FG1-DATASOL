    ...
    <div class="card-body" style="background-color:#f8f9fa;">
        <form method="POST">
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                    <input type="number" class="form-control" id="input-room-number" 
                            placeholder="Raumnummer z.B. 001" name="input-room-number" maxlength="3" 
                            required value="<?php echo $roomnumber; ?>">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                    <input type="text" class="form-control" id="input-room-name" 
                            placeholder="Raumname z.B. Computer-Lab" name="input-room-name" maxlength="45" 
                            required value="<?php echo $roomname; ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="input-room-description" class="col-sm-2 col-form-label">Raumbeschreibung</label>
                <div class="col-sm-7">
                    <textarea   class="form-control" id="input-room-description" rows="3" 
                                placeholder="Fügen Sie hier die Beschreibung für den Raum ein..." 
                                name="input-room-description" maxlength="500"><?php echo $roomdescription ?></textarea>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-1">
